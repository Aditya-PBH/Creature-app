// 🔐 Auth.js — Premium Login/Signup with Purple Gradient Theme
          ...
          <View style={s.card}>
            ...
            <View style={s.form}>
              ...
              <View style={s.socialRow}>
                ...
                <TouchableOpacity style={[s.socialBtn, s.fbSocialBtn]}>
...
const s = StyleSheet.create({
  ...
  // Tabs
  tabs: { flexDirection: 'row', backgroundColor: '#0A0A0F', borderRadius: 14, padding: 4, marginBottom: 24 },
  ...
  inputIcon: { fontSize: 16, color: '#666' },
  ...
  mainBtn: {
    ...
    backgroundColor: PURPLE, marginTop: 4,
  ...
  socialBtn: {
    flex: 1, backgroundColor: '#0D0D14', borderRadius: 14,
    paddingVertical: 13, alignItems: 'center',
    borderWidth: 1, borderColor: BORDER,
  },
  fbSocialBtn: { borderColor: '#1877F2' },
